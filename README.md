...
- durch klare Tests und Golden Vectors reproduzierbar entwickelt werden kann. :contentReference[oaicite:14]{index=14} :contentReference[oaicite:15]{index=15}
...
Dadurch dürfen Weiterleiter notwendige Felder wie Hop-Zähler, Route-Hinweise oder Link-Profile ändern, ohne die eigentliche Ende-zu-Ende-Sicherheit zu brechen. Genau diese Trennung ist eine der zentralen Designregeln des Systems. :contentReference[oaicite:16]{index=16} :contentReference[oaicite:17]{index=17}
